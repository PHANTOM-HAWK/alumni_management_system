...
if(isset($_POST['fpass']))
{
	if($_POST["utype"] == "1")
	{
		...
		else 
		{
			...
			$subject  =  "Here are your login details . . . ";
				$message = "This is in response to your request for reset login password as Alumnee of our Alumnee Management System.<br/>Your Name is ".$row['name'].".<br/>Your  Password is ".$row['upass'].".<br/>Don't give your password to anyone in your group, but do save it somewhere safe. <br/><br/> Enjoy!!..<br/>Regards,<br/>the management";
	...
	else if($_POST["utype"] == "2")
	{
		...
		else 
		{
			...
			$to = $email;
			$subject  =  "Here are your login details . . . ";
				$message = "This is in response to your request for reset login password as Staff of our Alumnee Management System.<br/>Your Name is ".$row['staffname'].".<br/>Your  Password is ".$row['staff_pass'].".<br/>Don't give your password to anyone in your group, but do save it somewhere safe. <br/><br/> Enjoy!!..<br/>Regards,<br/>the management";
