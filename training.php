...
<div class="bs-example" data-example-id="simple-horizontal-form">
    <form class="form-horizontal" action="" method="post">
      ...
      <input type="hidden" value="<?php echo $tid; ?>" name="trid"/>
        ...
        <div class="col-sm-6">
          <input type="date" class="form-control" id="participationdate" name="participationdate" placeholder="Participation date" required value="<?php echo $pdate; ?>">
        </div>
      </div>
	     <div class="form-group">
        ...
        <div class="col-sm-6">
          <input type="number" class="form-control" id="refcontactno" name="refcontactno" placeholder="Reference Contact Number" required value="<?php echo $rphone; ?>" >
        </div>
      </div>
       <div class="form-group">
