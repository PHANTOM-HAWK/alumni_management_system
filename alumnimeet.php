...
{
	$rs = mysqli_query($con,"update tblalumnimeet set event_name='".$_POST['eventname']."',loc='".$_POST['location']."',event_date='".$_POST['eventdate']."',event_time='".$_POST['eventtime']."',description='".$_POST['description']."',status='".$_POST['status']."') 
	where eventid='".$_POST['arid']."'");
	if($rs)
	{
   ...
   <h3>Alumni Meet</h3>
    ...
    <form class="form-horizontal" method="post">
	  ...
	  <div class="form-group">
        ...
        <div class="col-sm-6">
          <input type="date" class="form-control" id="eventdate" name="eventdate" required value="<?php echo $event_date  ; ?>" >
        </div>
      </div>
	  <div class="form-group">
