...
<div>
  <img class="mySlides" src="images/image1.png" style="style=width:500px;height:600px;">
  <img class="mySlides" src="images/image2.jpeg" style="style=width: 1100px;px;height: 600px;">
  <img class="mySlides" src="images/image3.jpeg" style="style=width:1100px;height:600px;">
...
<!--welcome-->
	...
	<div class="container">
			...
			<marquee behavior="scroll" scrollamount="10" direction="left" onmouseover="this.stop();" onmouseout="this.start();"><h3>Welcome to Alumni Management System </h3>	
</marquee>
