...
so get them back by signing up for Alumni today! </h4>	
			...
			<div class="col-md-8 content-top-2 animated wow fadeInRight" data-wow-duration="1000ms" data-wow-delay="500ms">
			 ...
			 <p>&nbsp;</p>
			<p>ALUMNNI helps institutes strategically build and manage their alumni network, by facilitating engagement, community-building, networking, communications and giving back. With alumnee, your Alumni data can be centralized and combined with a host of exciting front-end member modules and time-saving, back-end administration tools.</p>
